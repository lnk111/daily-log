(function(){
  ...
  const INC_CAT_RULES=[
    ...
    {cat:"빌려준돈", kw:["빌려준","빌려준돈","돌려받","상환받","갚음","꿔준","차용금 회수"]},
  ...
  const INC_CATS=["월급","배당금","빌려준돈","이자","애드포스트","협찬","기타"];   // 수입 카테고리 선택지(드롭다운 순서)
  ...
  const INC_CAT_COLORS={ "월급":"#2f9e69","배당금":"#3f7cc0","빌려준돈":"#8C7459","이자":"#14b8a6","애드포스트":"#d98a2b","협찬":"#c05fa8","기타":"#a1a1aa" };
  const INC_ORDER=["월급","배당금","이자","애드포스트","협찬","빌려준돈","기타"];   // 스택 쌓는 순서(아래→위)
  const INC_ICONS={ "월급":"💰","배당금":"📈","빌려준돈":"💸","이자":"🏦","애드포스트":"📊","협찬":"🎁","기타":"💬" };
