(function(){
  ...
  // 수입원 자동 분류 — 더 구체적인 규칙을 앞에 두어 먼저 매칭시킴
  const INC_CAT_RULES=[
    {cat:"배당금",   kw:["배당","배당금","dividend","분배금"]},
    {cat:"이자",     kw:["이자","예금이자","적금이자","이자수익","파킹","cma 이자"]},
    {cat:"n등분 정산", kw:["n등분","엔분","정산","더치","1/n","빌려준","돌려받","상환받","갚음","꿔준","회비"]},
    {cat:"애드포스트",kw:["애드포스트","adpost","애드센스","adsense","애드핏","구글광고","구글 광고"]},
    {cat:"협찬",     kw:["협찬","스폰서","ppl","광고비","제품제공","브랜디드","체험단","원고료"]},
    {cat:"월급",     kw:["월급","급여","봉급","상여","보너스","성과급","연봉","본업","임금","salary"]}
  ];
  const INC_CATS=["월급","배당금","n등분 정산","이자","애드포스트","협찬","기타"];   // 수입 카테고리 선택지(드롭다운 순서)
  ...
  const INC_CAT_COLORS={ "월급":"#2f9e69","배당금":"#3f7cc0","n등분 정산":"#8C7459","이자":"#14b8a6","애드포스트":"#d98a2b","협찬":"#c05fa8","기타":"#a1a1aa" };
  const INC_ORDER=["월급","배당금","이자","애드포스트","협찬","n등분 정산","기타"];   // 스택 쌓는 순서(아래→위)
  const INC_ICONS={ "월급":"💰","배당금":"📈","n등분 정산":"💸","이자":"🏦","애드포스트":"📊","협찬":"🎁","기타":"💬" };
